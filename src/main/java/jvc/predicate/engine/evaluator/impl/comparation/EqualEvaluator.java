...
public class EqualEvaluator<L extends PLAtomic<?>, R extends PLAtomic<?>> extends BinaryEvaluator<L, R, PLBoolean> {

    public EqualEvaluator() {
    }

    public EqualEvaluator(Evaluator<L> left, Evaluator<R> right) throws Exception {
        super(left, right);
    }
